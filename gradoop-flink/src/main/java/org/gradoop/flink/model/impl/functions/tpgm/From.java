...
/**
 * Implementation of the From retrieval operator.
 */
public class From extends RetrievalOperator {
/**
  ...
  /**
   * Creates a From instance with the given time stamps.
   *
   * @param from the from value to compare
   * @param to the to value to compare
   */
  public From(long from, long to) {
