 ...
 * @param <GC> type of the according graph collection instance
 */
public class CypherPatternMatching<
  ...
  GC extends BaseGraphCollection<G, V, E, GC>> extends PatternMatching<G, V, E, LG, GC> {
   ...
   */
  private DataSet<EPGMElement> constructFinalElements(LG graph, DataSet<Embedding> embeddings,
