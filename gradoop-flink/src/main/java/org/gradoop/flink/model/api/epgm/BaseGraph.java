 ...
 * @param <GC> the type of the logical graph that will be created with a provided factory
 */
public interface BaseGraph<
  ...
  /**
   * Get the factory that is responsible for creating an instance of a graph collection
   * of type {@link GC}.
   *
