...
/**
 * Test of the snapshot API functions of {@link org.gradoop.flink.model.impl.tpgm.TemporalGraph}.
 */
public class SnapshotApiTest extends GradoopFlinkTestBase {
  ...
  public void testAsOf() throws Exception {
    ...
    TemporalGraph input = loader.getLogicalGraphByVariable("g0")
  ...
  public void testContainedIn() throws Exception {
    ...
    TemporalGraph input = loader.getLogicalGraphByVariable("g4")
      .toTemporalGraph(new Extractor<>(), new Extractor<>(), new Extractor<>());
  ...
  public void testValidDuring() throws Exception {
    ...
    TemporalGraph input = loader.getLogicalGraphByVariable("g3")
      .toTemporalGraph(new Extractor<>(), new Extractor<>(), new Extractor<>());
